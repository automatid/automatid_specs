Pod::Spec.new do |s|
  ...
  s.dependency 'OTML' , '2.3.6' 
  s.dependency 'OTMLModels', '2.3.6' 
  s.dependency 'OTMLCore', '2.3.6' 
  s.dependency 'OTMLMRZReaderAddon', '2.3.6' 
  s.dependency 'OTMLNfcDocumentReaderModule', '2.3.6' 
  s.dependency 'OTMLFaceRecognitionAddon', '2.3.6' 
  s.dependency 'OTNFCPassportReader', '2.3.6' 
