Pod::Spec.new do |s|
  ...
  s.dependency 'AutomatID_OTML' , '4.0.6' 
  s.dependency 'AutomatID_OTMLModels', '4.0.6' 
  s.dependency 'AutomatID_OTMLCore', '4.0.6' 
  s.dependency 'AutomatID_OTMLMRZReaderAddon', '4.0.6' 
  s.dependency 'AutomatID_OTMLNfcDocumentReaderModule', '4.0.6' 
  s.dependency 'AutomatID_OTMLFaceRecognitionAddon', '4.0.6' 
