Pod::Spec.new do |s|
  ...
  s.dependency 'OTMLMRZReaderAddon', '2.3.5' 
  s.dependency 'OTMLNfcDocumentReaderModule', '2.3.5' 
  s.dependency 'OTMLFaceRecognitionAddon', '2.3.5' 
  s.dependency 'OTNFCPassportReader', '2.3.5' 
