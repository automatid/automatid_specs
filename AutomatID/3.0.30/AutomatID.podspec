Pod::Spec.new do |s|
  ...
  s.dependency 'AutomatID_OTML' , '3.0.30' 
  s.dependency 'AutomatID_OTMLModels', '3.0.30' 
  s.dependency 'AutomatID_OTMLCore', '3.0.30' 
  s.dependency 'AutomatID_OTMLMRZReaderAddon', '3.0.30' 
  s.dependency 'AutomatID_OTMLNfcDocumentReaderModule', '3.0.30' 
  s.dependency 'AutomatID_OTMLFaceRecognitionAddon', '3.0.30' 
