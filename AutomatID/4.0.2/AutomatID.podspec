Pod::Spec.new do |s|
  ...
  s.dependency 'AutomatID_OTMLMRZReaderAddon', '4.0.2' 
  s.dependency 'AutomatID_OTMLNfcDocumentReaderModule', '4.0.2' 
  s.dependency 'AutomatID_OTMLFaceRecognitionAddon', '4.0.2' 
