Pod::Spec.new do |s|
  ...
  s.dependency 'AutomatID_OTMLMRZReaderAddon', '3.0.36' 
  s.dependency 'AutomatID_OTMLNfcDocumentReaderModule', '3.0.36' 
  s.dependency 'AutomatID_OTMLFaceRecognitionAddon', '3.0.36' 
