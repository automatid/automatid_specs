Pod::Spec.new do |s|
  ...
  s.dependency 'OTHFOTML' , '4.0.19' 
  s.dependency 'OTHFOTMLModels', '4.0.19' 
  s.dependency 'OTHFOTMLCore', '4.0.19' 
  s.dependency 'OTHFOTMLMRZReaderAddon', '4.0.19' 
  s.dependency 'OTHFOTMLNfcDocumentReaderModule', '4.0.19' 
  s.dependency 'OTHFOTMLFaceRecognitionAddon', '4.0.19' 
