Pod::Spec.new do |s|
  s.name             = 'OTHFOTMLNfcDocumentReaderModule'
  s.version          = '4.0.17'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'git@github.com:automatid/OTHFios_artifacts.git', :tag => s.version.to_s } # TODO: use the new github reposiories
  s.ios.vendored_frameworks = 'OTHFOTMLNfcDocumentReaderModule.xcframework'
